...
export const ConfigPage = () => {
    ...
    return (
        <div className="p-8 max-w-7xl mx-auto w-full">
            ...
            {/* Tabs Navigation */}
            <div className="flex p-1.5 bg-slate-100 dark:bg-slate-900 rounded-2xl w-fit overflow-x-auto scrollbar-hide border border-slate-200/50 dark:border-white/5 shadow-inner backdrop-blur-sm mb-8 gap-1">
