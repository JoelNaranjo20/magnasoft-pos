                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 divide-y md:divide-y-0 md:divide-x divide-slate-200 dark:divide-slate-700">
                            ...
                            <div className="p-4 flex flex-col space-y-3">
                                ...
                                <div className={`rounded-2xl p-4 text-center border-2 ${
                                    ...
                                    <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-1">Efectivo en Caja</p>
                                    <p className={`text-3xl font-black tabular-nums ${cashFlowTotal >= 0 ? 'text-emerald-600 dark:text-emerald-400' : 'text-rose-600 dark:text-rose-400'}`}>
                                        ${cashFlowTotal.toLocaleString()}
                                    </p>
                                    {sessionOpeningBalance > 0 && (
                                        <p className="text-[10px] text-slate-400 font-medium mt-1.5 flex items-center justify-center gap-1">
                                            <span className="w-1 h-1 rounded-full bg-slate-300"></span>
                                            Base inicial: ${sessionOpeningBalance.toLocaleString()}
                                        </p>
                                    )}
                                </div>
                                ...
                                <div className="bg-slate-50 dark:bg-slate-900/50 rounded-2xl border border-slate-200 dark:border-slate-700 p-3.5 space-y-1.5">
